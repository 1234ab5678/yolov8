...
from nets.yolo_training import (ModelEMA, get_lr_scheduler, Loss,
...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------#
    #   backbone: 所使用到的主干, 包括
    #   cspdarknet, DeformableCSPDarkNet, MobileCSPDarkNet,
    #   fasternet_s, fasternet_l, fasternet_m,
    ...
    #   RepVGG_A0, RepVGG_A1, RepVGG_A2, RepVGG_B0, RepVGG_B1, RepVGG_B1g2, RepVGG_B1g4, RepVGG_B2, RepVGG_B2g2, RepVGG_B2g4,
    #   RepVGG_B3, RepVGG_B3g2, RepVGG_B3g4, RepVGG_D2se
    #   mobilenet_v3_small, mobilenet_v3_large
    #   swin_tiny_patch4_window7_224, swin_small_patch4_window7_224, swin_base_patch4_window7_224, swin_base_patch4_window12_384
    #   swin_base_patch4_window7_224_in22k, swin_base_patch4_window12_384_in22k, swin_large_patch4_window7_224_in22k, swin_large_patch4_window12_384_in22k
    # ------------------------------------------------------#
    backbone = 'fasternet_s'
    # ------------------------------------------------------#
    #   neck            所使用到的特征增强网络
    #   FPN, MobileFPN, AttentionFPN
    # ------------------------------------------------------#
    neck = 'FPN'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #   创建yolo模型
    #------------------------------------------------------#
    model = YoloBody(input_shape, num_classes, phi, backbone=backbone, neck=neck, pretrained=pretrained)
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
