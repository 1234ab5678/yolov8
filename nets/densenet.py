...
def densenet121(pretrained, num_classes, **kwargs: Any) -> DenseNet:
    # Top-1 error: 25.35%
    # 'densenet121': 'https://download.pytorch.org/models/densenet121-a639ec97.pth'
...
def densenet161(pretrained, num_classes, **kwargs: Any) -> DenseNet:
    # Top-1 error: 22.35%
    # 'densenet161': 'https://download.pytorch.org/models/densenet161-8d451a50.pth'
    model = DenseNet(growth_rate=48,
                    block_config=(6, 12, 36, 24),
                    num_init_features=96,
                    **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['densenet161'], model_dir='./model_data',
                                              progress=True)
        model.load_state_dict(state_dict, strict=False)
    return model

def densenet169(pretrained, num_classes, **kwargs: Any) -> DenseNet:
    # Top-1 error: 24.00%
    # 'densenet169': 'https://download.pytorch.org/models/densenet169-b2777c0a.pth'
    model = DenseNet(growth_rate=32,
                    ...
                    **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['densenet169'], model_dir='./model_data',
                                              progress=True)
        model.load_state_dict(state_dict, strict=False)
    return model


def densenet201(pretrained, num_classes, **kwargs: Any) -> DenseNet:
    # Top-1 error: 22.80%
    # 'densenet201': 'https://download.pytorch.org/models/densenet201-c1103571.pth'
    model = DenseNet(growth_rate=32,
                    ...
                    **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['densenet201'], model_dir='./model_data',
                                              progress=True)
        model.load_state_dict(state_dict, strict=False)
    return model
