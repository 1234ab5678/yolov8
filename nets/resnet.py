...
def resnet18(pretrained, num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, include_top=include_top)
    if pretrained:
...
def resnet152(pretrained, num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet101-5d3b4d8f.pth
    model = ResNet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, include_top=include_top)
    if pretrained:
