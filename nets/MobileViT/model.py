...
model_urls = {
    'mobilevit_xx_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_xxs.pt',
    'mobilevit_x_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_xs.pt',
    'mobilevit_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_s.pt',
}
...
def mobile_vit_xx_small(pretrained, num_classes: int = 1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilevit_xx_small'], model_dir='./model_data',
                                              progress=True)
        m.load_state_dict(state_dict)
    return m


def mobile_vit_x_small(pretrained, num_classes: int = 1000):
    # pretrain weight link
    # https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_xs.pt
    config = get_config("x_small")
    m = MobileViT(config, num_classes=num_classes)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilevit_x_small'], model_dir='./model_data',
                                              progress=True)
        m.load_state_dict(state_dict)
    return m


def mobile_vit_small(pretrained, num_classes: int = 1000):
    # pretrain weight link
    # https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_s.pt
    config = get_config("small")
    m = MobileViT(config, num_classes=num_classes)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilevit_small'], model_dir='./model_data',
                                              progress=True)
        m.load_state_dict(state_dict)
    return m
