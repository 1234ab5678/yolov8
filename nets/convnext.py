...
def convnext_tiny(pretrained, num_classes: int):
...
def convnext_small(pretrained, num_classes: int):
...
def convnext_base(pretrained, num_classes: int):
...
def convnext_large(pretrained, num_classes: int):
...
def convnext_xlarge(pretrained, num_classes: int):
